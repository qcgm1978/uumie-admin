...
<input type="hidden" id="url" value="<?php echo $this->createUrl("monitor/fieldlive",array('uid'=>$uid,'stime'=>$stime,'etime'=>$etime)) ?>">
    ...
    <div class="select">
      ...
      <!--搜索栏结束-->
      <!--内容开始-->
    <div class="Search fiv">
        <ul width="100%" border="0" style="margin-top:10px">
              <?php foreach($info as $k=> $v): ?>
              <li>
                  <a href="javascript::void(0)"><img src="<?php echo IMG_PATH.'201803'."/".substr($k, 0,8)."/".$v ?>" style="border:1px #ccc solid;"width="80px" height="60px"/></a>
