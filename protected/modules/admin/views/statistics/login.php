<div class="span10">
    <h4 class="page-title">用户登陆统计列表</h4>
...
<div class="well">
    <table class="table">
      <thead>
      <input type="hidden" id="url" value="<?php echo $this->createUrl("statistics/login") ?>">
      <input type="hidden" id="listUrl" value="<?php echo $this->createUrl("statistics/login") ?>">
       <tr role="row">
       <th aria-label="推广来源">推广来源</th>
       <th aria-label="会员人数">会员人数</th>
       <th aria-label="游客人数">游客人数</th>
    </tr>
      </thead>
      <tbody id="content">
...
<script src="<?php echo Yii::app()->request->baseUrl ?>/assets/admin/statistics/login.js" type="text/javascript"></script>
