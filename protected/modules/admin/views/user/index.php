					  ...
					  <div class="row margin-top-10 margin-bottom-10" style="margin:0">			
						...
						<thead>
							<tr role="row">
							   ...
							   <th class="sorting_disabled" tabindex="0" rowspan="1" colspan="1" aria-label="帐号" style="white-space: nowrap;">帐号</th>
						...
						<tbody role="alert" aria-live="polite" aria-relevant="all">
							...
							<tr class="even">
								<td class="" style="white-space: nowrap;"><?php echo $v->uid ?></td>
								<td class="" style="white-space: nowrap;">MNRY</td>
								<td class="" style="white-space: nowrap;"><?php echo $v->username ?></td>
								<td class="" style="white-space: nowrap;">nickname</td>
								<td class="" style="white-space: nowrap;"><?php echo date("Y-m-d H:i:s",$v->reg_time) ?></td>
								<td class="" style="white-space: nowrap;"><?php echo date("Y-m-d H:i:s",$v->last_login) ?></td>
								<td class="" style="white-space: nowrap;"><?php echo $v->last_login_ip ?></td>
								<td class="" style="white-space: nowrap;"><?php echo $v->last_login_server ?></td>
								<td class="" style="white-space: nowrap;"><?php echo $v->comefrom ?></td>
								<td class="" style="white-space: nowrap;">齐齐哈尔运输分公司</td>
								<td class="" style="white-space: nowrap;"><?php echo $v['UserVirtual']->uid ?></td>
							</tr>
							<?php endforeach ?>
							</tbody>
						</table>
...
<!-- end widget grid -->
<script src="<?php echo Yii::app()->request->baseUrl ?>/assets/admin/user/index.js"></script>
