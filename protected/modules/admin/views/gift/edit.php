...
<div class="well">
    ...
    <?php $form = $this->beginWidget('CActiveForm'); ?>
        <label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;礼物名称：<input class="input-sm" id="giftname" type="text" onblur="verify()">
        <span style="color:#FF0000">*</span>
        <span id="nameNull" class="alert alert-warning"></span>
        </label>
        <label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;礼物价格：<input class="input-sm" id="gifprice" type="text" onblur="verify()">
        <span style="color:#FF0000">*</span>
        <span id="priceNull" class="alert alert-warning"></span>
        </label>
        <label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;礼物单位：<input class="input-sm" id="giftunit" type="text" onblur="verify()">
        <span style="color:#FF0000">*</span>
        ...
        <input class="input-sm" id="img" type="hidden">
        <input class="input-sm" id="thumb" type="hidden">
        <input class="input-sm" id="flash" type="hidden">
        </label>  
        <label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;播放时长：<input class="input-sm" id="giftlife" type="text" onblur="verifys()">
        <span style="color:#FF0000">*</span>
